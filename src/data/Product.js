...
const products = [
  {
    ...
    category: "PCs", 
    description: "High performance gaming PC with Charmander theme.",
    specifications: [
      "GIGABYTE RTX 2060",
      "AMD Ryzen 5 3600",
      "AMD Wraith Stealth",
  ...
  },
  {
    ...
    category: "PCs", 
    description: "High performance gaming PC with Red RGB theme.",
    specifications: [
      "ASUS GTX 1070",
      "i5 11400F",
      "16GB DDR4 RAM",
  ...
  },
  {
    ...
    category: "Components", 
    description: "High performance Hyper X Fury",
